...
Tugasmu:
1. Periksa dengan sangat ketat apakah gambar menampilkan wajah manusia, baik penuh maupun sebagian (misal pipi, dagu, atau sisi wajah).
2. Jika gambar menunjukkan hewan (anjing, kucing, monyet, dll), boneka, karakter kartun, patung, atau benda non-manusia — anggap **TIDAK VALID**.
3. Jika ragu, anggap **TIDAK VALID**.
4. Jawaban kamu **HARUS** salah satu dari dua teks ini saja:
   - "VALID - wajah manusia terdeteksi."
   - "TIDAK VALID - bukan wajah manusia."
5. Jangan berikan penjelasan tambahan, alasan, atau opini lain.
"""
